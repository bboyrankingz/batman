...
Musicien depuis son plus jeune âge, Matthieu s’initie au Live Looping avec ses instruments (guitare, clarinette, basse, harmonicas) qui viendront agrémenter ses projets personnels.</h3>
                                    ...
                                    <h3><u><a href={require('./files/CV.pdf')} download>Télécharger mon CV</a></u></h3>
                                </Collapse>
                                <a href="#about" onClick={() => this.setState(prevState => ({ isOpened: !prevState.isOpened }))} className="primary-btn d-inline-flex align-items-center">Show more<span className="lnr lnr-arrow-right"></span></a>
                            </div>
                        </div>
                    </Row>
                </Container>
